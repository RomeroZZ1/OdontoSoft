					...
					<ul class="nav nav-primary">
						...
						<li class="nav-item">
							...
							<div class="collapse" id="user">
								<ul class="nav nav-collapse">
									<li>
										<a href="../../OdontoStore/folder/usuarios.php">
											<span class="sub-item">Mostrar</span>
										</a>
									</li>
