														...
														foreach ($db->query($sql) as $row) {
															...
															<tr>
																...
																<td>
																	<?php if ($row['estado'] == 1) { ?>
																		<form method="get"
																			action="javascript:activo('<?php echo $row['codpaci']; ?>')">
																			<button type="submit"
																	...
																	<?php } else { ?>
																		...
																		<form method="get"
																			action="javascript:inactivo('<?php echo $row['codpaci']; ?>')">
																			<button type="submit"
																...
																<td>
																	<div class="form-button-action">
																		...
																		<button
																			href="#editRowModal=<?php echo $row['codpaci']; ?>"
																			class="btn btn-link btn-primary btn-lg"
																			data-toggle="modal" title=""
																			data-original-title="Edit Task"
																			data-target="#editRowModal<?php echo $row['codpaci']; ?>">
																			<i class="fa fa-edit"></i>

																		</button>

																		<button
																			href="#PassRowModal=<?php echo $row['codpaci']; ?>"
																			class="btn btn-link btn-primary btn-lg"
																			data-toggle="modal" title=""
																			data-original-title="Pass Task"
																			data-target="#PassRowModal<?php echo $row['codpaci']; ?>">
																			<i class="fa fa-key"></i>

																		</button>

																		<button
																			href="#deleteRowModal=<?php echo $row['codpaci']; ?>"
																			class="btn btn-link btn-danger btn-lg"
																			data-toggle="modal" title=""
																			data-original-title="Delete Task"
																			data-target="#deleteRowModal<?php echo $row['codpaci']; ?>">
