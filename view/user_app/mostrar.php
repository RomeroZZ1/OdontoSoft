							...
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<div class="dropdown-user-scroll scrollbar-outer">
									<li>
										<div class="user-box">
											...
											<div class="u-text">
												...
												<p class="text-muted">Clientes</p><a href="../user/user.php"
									...
									<li>
										...
										<a class="dropdown-item" href="../user/user.php">Mi Perfil</a>
				...
				<div class="sidebar-content">
					...
					<ul class="nav nav-primary">
						<li class="nav-item">
							...
							<a data-toggle="collapse" href="#base2" class="collapsed" aria-expanded="false">
													...
													if (mysqli_num_rows($query) > 0) {
														while ($row = mysqli_fetch_assoc($query)) {
															...
															<td>
																<?php if ($row['estado'] == 1) { ?>
																	<form method="get"
																		action="javascript:activo('<?php echo $row['codcit']; ?>')">
																...
																<?php } else { ?>
																	...
																	<form method="get"
																		action="javascript:inactivo('<?php echo $row['codcit']; ?>')">
