														...
														foreach ($value as $va) { ?>
															<tr>
																...
																<td>
																	<?php if ($va['estado'] == 1) { ?>
																		<form method="get"
																			action="javascript:activo('<?php echo $va['codcit']; ?>')">
																	...
																	<?php } else { ?>
																		...
																		<form method="get"
																			action="javascript:inactivo('<?php echo $va['codcit']; ?>')">
																			<button type="submit"
																				class="btn btn-danger btn-xs">Pendiente</button>
																		</form>
																	<?php } ?>
																</td>
																...
																<td>
																	<div class="form-button-action">
																		...
																		<button
																			href="#deleteRowModal=<?php echo $va['codcit']; ?>"
